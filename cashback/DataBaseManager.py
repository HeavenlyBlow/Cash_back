...
class SQL:
    ...
    def registration(self, number, name, points, add_id):
        try:
            ...
            e = sys.exc_info()[1]
            print("Error of registration: " + str(number) + " " + str(points) + " " + str(add_id))
            print(str(e))
            return False
    ...
    def get_information(self, number):
        try:
            ...
            print("Number " + str(number) + " not found")
            return "Не найдено"
    ...
    def delete_information_from_list_admins(self, admin_name):
        try:
            ...
            print("Error in del_inforamtion_from_list_admins")
            e = sys.exc_info()[1]
            print(str(e))
    ...
    def set_information_in_list_admins(self, user_id, admin_name):
        try:
            ...
            print("Error in set_information_in_list_admins")
            e = sys.exc_info()[1]
            print(str(e))
    ...
    def set_information_in_history(self, number, date, time, point, id_add):
        ...
        try:
            ...
            print("Error in set_inforamteion_in_history")
            e = sys.exc_info()[1]
            print(str(e))
    ...
    def get_information_in_history(self, number, add_id):
        try:
            ...
            print("Error in get_inforamtion_in_history")
            e = sys.exc_info()[1]
            print(str(e))
            return "Ошибка"
